...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        header('Location: cadastro.php?msg=true');
    }
}
?>
...
<body>
  ...
  <div class="container">
    ...
    <div class="d-grid gap-2 mx-auto">
      <h3 class="h3-cadastro">Cadastre-se</h3>
      ...
      <?php
        ...
        elseif(isset($_GET['noExiste']) && !empty($_GET['noExiste']))
        {
      ?>
            <div class="container">
                <div class="alert alert-warning" role="alert">
                    <span class="card-title">Alert!</span>
                    <p>Usuário não existente! Cadastre-se.</p>
                </div>
            </div>
      <?php
        }
